...
const CLUBS = [
  ...
  { name: "Jeunesse Sportive de Kairouan", short: "JSK", city: "Kairouan", founded: 1953, stadium: "Stade du 7-Novembre", cap: 9000, league: "Ligue 1", region: "Centre-Ouest", titles: 0, color: "#4ade80" },
  { name: "Association Sportive de Gabès", short: "ASG", city: "Gabès", founded: 1944, stadium: "Stade Ben Jannet de Gabès", cap: 8500, league: "Ligue 1", region: "Sud", titles: 0, color: "#a855f7" },
  { name: "Union Sportive de Tataouine", short: "UST", city: "Tataouine", founded: 1944, stadium: "Stade Municipal de Tataouine", cap: 7000, league: "Ligue 1", region: "Sud", titles: 0, color: "#f87171" },
  { name: "Espérance Sportive Métlaoui", short: "ESM", city: "Métlaoui", founded: 1942, stadium: "Stade de Métlaoui", cap: 7000, league: "Ligue 1", region: "Sud-Ouest", titles: 0, color: "#38bdf8" },
  { name: "Club Sportif Hammam-Lif", short: "CSHL", city: "Hammam-Lif", founded: 1907, stadium: "Stade de Hammam-Lif", cap: 6500, league: "Ligue 1", region: "Grand Tunis", titles: 1, color: "#60a5fa" },
  ...
  { name: "Union Sportive de Ben Guerdane", short: "USBG", city: "Ben Guerdane", founded: 1955, stadium: "Stade de Ben Guerdane", cap: 5000, league: "Ligue 1", region: "Sud", titles: 0, color: "#34d399" },
  { name: "Espérance Sportive de Zarzis", short: "ESZ", city: "Zarzis", founded: 1948, stadium: "Stade Municipal de Zarzis", cap: 6000, league: "Ligue 1", region: "Sud", titles: 0, color: "#a3e635" },
